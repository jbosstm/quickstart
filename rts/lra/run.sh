...
case "$(uname)" in
   CYGWIN*) export NARAYANA_INSTALL_LOCATION=`cygpath -w $(pwd)/narayana-full-6.0.0.Final` ;;
   *)       export NARAYANA_INSTALL_LOCATION=$(pwd)/narayana-full-6.0.0.Final ;;
esac

rm -rf $NARAYANA_INSTALL_LOCATION
NARAYANA_ZIP="narayana-full-6.0.0.Final-bin.zip"
