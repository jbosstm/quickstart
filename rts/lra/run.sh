...
case "$(uname)" in
   CYGWIN*) export NARAYANA_INSTALL_LOCATION=`cygpath -w $(pwd)/narayana-full-5.12.6.Final` ;;
   *)       export NARAYANA_INSTALL_LOCATION=$(pwd)/narayana-full-5.12.6.Final ;;
esac

rm -rf $NARAYANA_INSTALL_LOCATION
NARAYANA_ZIP="narayana-full-5.12.6.Final-bin.zip"
