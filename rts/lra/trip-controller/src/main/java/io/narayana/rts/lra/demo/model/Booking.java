...
public class Booking {
    ...
    public void clearDetails() {
        details = new Booking[0];
    }

    public static List<Booking> getBookingArray(String responseData) throws IOException {
        responseData = responseData.replaceAll("\"", "");
        responseData = responseData.replaceAll("\\\\", "\"");
        return Arrays.asList(new ObjectMapper().readValue(responseData, Booking[].class));
    }
...
//        if (!Arrays.equals(getDetails(), booking.getDetails()) return false;
        return true;
    }
