...
QUICKSTART_NARAYANA_VERSION=${QUICKSTART_NARAYANA_VERSION:-5.12.4.Final-SNAPSHOT}
...
function int_env {
  ...
  [ $NARAYANA_CURRENT_VERSION ] || export NARAYANA_CURRENT_VERSION="5.12.4.Final-SNAPSHOT" 
...
function build_narayana {
  ...
  cp -rp narayana-full/target/narayana-full-5.12.4.Final-SNAPSHOT-bin.zip $WORKSPACE
  cd ..
  rm -rf narayana
}
