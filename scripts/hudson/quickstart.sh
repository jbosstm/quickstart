...
QUICKSTART_NARAYANA_VERSION=${QUICKSTART_NARAYANA_VERSION:-5.10.5.Final-SNAPSHOT-SNAPSHOT}
...
function int_env {
  ...
  [ $NARAYANA_CURRENT_VERSION ] || export NARAYANA_CURRENT_VERSION="5.10.5.Final-SNAPSHOT-SNAPSHOT" 
...
function build_narayana {
  ...
  cp -rp narayana-full/target/narayana-full-5.10.5.Final-SNAPSHOT-SNAPSHOT-bin.zip $WORKSPACE
  cd ..
  rm -rf narayana
}
