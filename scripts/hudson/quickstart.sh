...
QUICKSTART_NARAYANA_VERSION=${QUICKSTART_NARAYANA_VERSION:-5.9.6.Final}
...
function int_env {
  ...
  [ $NARAYANA_CURRENT_VERSION ] || export NARAYANA_CURRENT_VERSION="5.9.6.Final" 
...
function build_narayana {
  ...
  cp -rp narayana-full/target/narayana-full-5.9.6.Final-bin.zip $WORKSPACE
  cd ..
  rm -rf narayana
}
