...
function int_env {
  ...
  QUICKSTART_NARAYANA_VERSION=${QUICKSTART_NARAYANA_VERSION:-7.3.1.Final-SNAPSHOT}
  REDUCE_SPACE=${REDUCE_SPACE:-0}

  [ $NARAYANA_CURRENT_VERSION ] || export NARAYANA_CURRENT_VERSION="7.3.1.Final-SNAPSHOT" 
