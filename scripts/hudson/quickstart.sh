...
QUICKSTART_NARAYANA_VERSION=${QUICKSTART_NARAYANA_VERSION:-5.10.6.Final-SNAPSHOT}
...
function build_narayana {
  ...
  cp -rp narayana-full/target/narayana-full-5.10.6.Final-SNAPSHOT-bin.zip $WORKSPACE
  cd ..
  rm -rf narayana
}
