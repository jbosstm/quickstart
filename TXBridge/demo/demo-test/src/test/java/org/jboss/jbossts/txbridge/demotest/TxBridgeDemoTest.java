...
public class TxBridgeDemoTest {
    ...
    private static final String XTS_DEMO_ARCHIVE = "../../../XTS/demo/ear/target/xts-demo-ear-4.17.10.Final-SNAPSHOT.ear";
    ...
    public static Archive<?> createXTSDemoArchive() throws Exception {
        Archive<?> archive = ShrinkWrap.create(ZipImporter.class, "xts-demo-ear-4.17.10.Final-SNAPSHOT.ear")
