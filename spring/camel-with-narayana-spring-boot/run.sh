...
java -jar target/camel-with-narayana-spring-boot-5.10.5.Final.jar 1>./target/test.log 2>&1 &
...
if [ ! -z "$STATUS" ]; then
    ...
    java -Drecover=true -jar target/camel-with-narayana-spring-boot-5.10.5.Final.jar 1>./target/test.log 2>&1 &
    check_application_alive
