...
java -jar target/camel-with-narayana-spring-boot-7.2.1.Final-SNAPSHOT.jar 1>./target/test.log 2>&1 &
...
if [ ! -z "$STATUS" ]; then
    ...
    java -Drecover=true -jar target/camel-with-narayana-spring-boot-7.2.1.Final-SNAPSHOT.jar 1>./target/test.log 2>&1 &
    check_application_alive
