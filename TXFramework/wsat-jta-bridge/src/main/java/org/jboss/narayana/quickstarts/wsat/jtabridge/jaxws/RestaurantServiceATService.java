 ...
 * 
 */
@WebServiceClient(name = "RestaurantServiceATService", targetNamespace = "http://www.jboss.org/narayana/quickstarts/wsat/simple/Restaurant")
public class RestaurantServiceATService extends Service {
    ...
    public RestaurantServiceATService() {
        super(RESTAURANTSERVICEATSERVICE_WSDL_LOCATION, new QName(
                "http://www.jboss.org/narayana/quickstarts/wsat/simple/Restaurant", "RestaurantServiceATService"));
    }
    ...
    public RestaurantServiceAT getRestaurantServiceAT() {
        return super.getPort(
                new QName("http://www.jboss.org/narayana/quickstarts/wsat/simple/Restaurant", "RestaurantServiceAT"),
